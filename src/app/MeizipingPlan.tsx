const dayOne = [
  ["06:45", "广州集合、分车和装备检查，提前加满油。"],
  ["07:00", "出发前往上坪村，节假日额外预留 30–60 分钟。"],
  ["10:30", "抵达上坪村，停车、热身、核对离线轨迹。"],
  ["11:00", "开始 8–9 公里环线，领队在前、收队在后。"],
  ["13:15", "阴凉处路餐，不开火，垃圾全部带走。"],
  ["16:00", "陆续返回上坪村，拉伸、换干衣并清点人员。"],
  ["17:15", "前往阳山县城，以实时导航为准。"],
  ["19:30", "阳山鸡、阳山豆腐聚餐，司机不饮酒。"],
];
    ...
    <div className="app-shell plan-shell">
      ...
      <main className="app-page app-page--with-bottom-bar plan-page">
        <section className="plan-hero">
          ...
          <h2>古道、石林和朋友局</h2>
          <p>广州出发，默认走上坪村起终点环线。按年轻人中等节奏规划，不赶路、不摸黑、不把长线当默认。</p>
        ...
        <aside className="plan-callout">
          <strong>硬截止：11:15</strong>
          11:15 仍未开始徒步，就不再硬走完整环线，改成县城休闲或择日再走。
        </aside>
