const dayOne = [
  ["07:45", "花都新华集合，早餐提前吃好，集合前加满油。"],
  ["08:00", "车轮出发，含一次短暂停靠按 3 小时预留。"],
  ["11:00", "抵达上坪村，停车、热身、核对离线轨迹。"],
  ["11:20", "开始 8–9 公里环线，领队在前、收队在后。"],
  ["13:30", "阴凉处路餐，不开火，垃圾全部带走。"],
  ["16:30", "陆续返回上坪村，拉伸、换干衣并清点人员。"],
  ["17:45", "前往阳山县城，以实时导航为准。"],
  ["20:00", "阳山鸡、阳山豆腐聚餐，司机不饮酒。"],
];
  ...
  return (
    <div className="app-shell plan-shell">
      ...
      <main className="app-page app-page--with-bottom-bar plan-page">
        ...
        <aside className="plan-callout">
          <strong>硬截止：11:30</strong>
          11:30 仍未开始徒步，就不再硬走完整环线，改成县城休闲或择日再走。
        </aside>
