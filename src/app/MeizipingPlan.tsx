const dayOne = [
  ["05:50", "广州集合、分车和装备检查，提前加满油。"],
  ["06:10", "出发前往上坪村，节假日额外预留 30–60 分钟。"],
  ["09:30", "抵达上坪村，停车、热身、核对离线轨迹。"],
  ["10:00", "开始 8–9 公里环线，领队在前、收队在后。"],
  ["12:30", "阴凉处路餐，不开火，垃圾全部带走。"],
  ["15:00", "返回上坪村，拉伸、换干衣并清点人员。"],
  ["16:00", "前往阳山县城，以实时导航为准。"],
  ["18:30", "阳山鸡、阳山豆腐聚餐，司机不饮酒。"],
];
  ...
  return (
    <div className="app-shell plan-shell">
      ...
      <main className="app-page app-page--with-bottom-bar plan-page">
        ...
        <aside className="plan-callout">
          <strong>硬截止：10:30</strong>
          10:30 仍未抵达入口，就不再硬走完整环线，改成县城休闲或择日再走。
        </aside>
